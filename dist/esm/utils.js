export function cloneWithJSON(data) {
    return JSON.parse(JSON.stringify(data));
}
export function deepEqualWithJSON(data1, data2) {
    return JSON.stringify(data1) === JSON.stringify(data2);
}
export function clonePojoTree(data) {
...
export function clonePojoGraph(data, cache = new Map()) {
    if (typeof data !== 'object' || data === null) {
        return data;
    }
...
export function clonePojoGraphAndSortProps(data, cache = new Map()) {
    if (typeof data !== 'object' || data === null) {
        return data;
    }
    const cached = cache.get(data);
...
export function deepEqualSameShape(data1, data2) {
...
export function deepEqualDiffShape(data1, data2) {
    if (Array.isArray(data1)) {
        if (Array.isArray(data2) === false) {
            return false;
        }
...
*/
export function getCallFrames(exclude) {
